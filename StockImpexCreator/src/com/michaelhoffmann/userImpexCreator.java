...
public class userImpexCreator {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            BufferedReader bufread = new BufferedReader(new InputStreamReader(new FileInputStream("targetFiles\\FOS-AT\\userData.csv"), "UTF-8"));
            filewrite = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("targetFiles\\FOS-AT\\userData_Impex.txt", false), StandardCharsets.UTF_8));
            ...
            for (String s : users) {
                ...
                filewrite.write(";" + email + ";" + email + ";" + salutation + ";" + firstName + ";JMeter_Testuser;" + "en" + ";EUR;customergroup;;" + email + ";\n");
